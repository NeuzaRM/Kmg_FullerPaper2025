...
filtered_transcripts=/labs/mtfuller/ProjectCompleteIsoform/KmgProject_20240409/Merge_KmgKD/SQANTI3_filtered/tappAS/tappAS_outputs/tappAS_Transcripts_filtered_KmgKD.txt

gtf_file=/labs/mtfuller/ProjectCompleteIsoform/KmgProject_20240409/Merge_KmgKD/SQANTI3_filtered/TAMA_merge_BamGal4_KmgKD_corrected_filtered_corrected.gtf


python GTF_tappASfiltered.py $filtered_transcripts $gtf_file
