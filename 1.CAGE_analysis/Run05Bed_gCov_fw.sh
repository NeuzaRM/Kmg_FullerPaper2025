...
-g ../dm6.ucsc.chrom.sizes \
-d -5 -strand + > BamGal4.1_R1_trimmed_Aligned.sortedByCoord.out.Q255.chr.bed_fw_count.txt

bedtools genomecov -ibam ./BamGal4.2_R1_trimmed_Aligned.sortedByCoord.out.Q255.chr.bam \
-g ../dm6.ucsc.chrom.sizes \
-d -5 -strand + > BamGal4.2_R1_trimmed_Aligned.sortedByCoord.out.Q255.chr.bed_fw_count.txt

bedtools genomecov -ibam ./K1_trimmed_Aligned.sortedByCoord.out.Q255.chr.bam \
-g ../dm6.ucsc.chrom.sizes \
-d -5 -strand + > K1_trimmed_Aligned.sortedByCoord.out.Q255.chr.bed_fw_count.txt

bedtools genomecov -ibam ./K2_trimmed_Aligned.sortedByCoord.out.Q255.chr.bam \
-g ../dm6.ucsc.chrom.sizes \
-d -5 -strand + > K2_trimmed_Aligned.sortedByCoord.out.Q255.chr.bed_fw_count.txt
