...
-d -3 -strand + > 3Pseq-BAMgal4-1-ACCAGT_S3_R1_001_trimmed_clean_Aligned.sortedByCoord.out.Q255.chr_fw_count.txt

bedtools genomecov -ibam ./3Pseq-BAMgal4-2-TGCACG_S4_R1_001_trimmed_clean_Aligned.sortedByCoord.out.Q255.chr.bam \
-g ./dm6.ucsc.chrom.sizes \
-d -3 -strand + > 3Pseq-BAMgal4-2-TGCACG_S4_R1_001_trimmed_clean_Aligned.sortedByCoord.out.Q255.chr_fw_count.txt

bedtools genomecov -ibam ./3Pseq-KmgKD-1-CAGCGT_S1_R1_001_trimmed_clean_Aligned.sortedByCoord.out.Q255.chr.bam \
-g ./dm6.ucsc.chrom.sizes \
-d -3 -strand + > 3Pseq-KmgKD-1-CAGCGT_S1_R1_001_trimmed_clean_Aligned.sortedByCoord.out.Q255.chr_fw_count.txt

bedtools genomecov -ibam ./3Pseq-KmgKD-2-GATCAC_S2_R1_001_trimmed_clean_Aligned.sortedByCoord.out.Q255.chr.bam \
-g ./dm6.ucsc.chrom.sizes \
-d -3 -strand + > 3Pseq-KmgKD-2-GATCAC_S2_R1_001_trimmed_clean_Aligned.sortedByCoord.out.Q255.chr_fw_count.txt
