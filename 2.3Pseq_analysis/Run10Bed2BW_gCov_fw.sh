...
-scale 0.220981377 -bg -3 -strand + > 3Pseq-BAMgal4-1-ACCAGT_S3_R1_001_trimmed_clean_Aligned.sortedByCoord.out.Q255.chr.bed_fw.bg

bedtools genomecov -i 3Pseq-BAMgal4-2-TGCACG_S4_R1_001_trimmed_clean_Aligned.sortedByCoord.out.Q255.chr.bed \
-g dm6.ucsc.chrom.sizes \
-scale 0.225634345 -bg -3 -strand + > 3Pseq-BAMgal4-2-TGCACG_S4_R1_001_trimmed_clean_Aligned.sortedByCoord.out.Q255.chr.bed_fw.bg

bedtools genomecov -i 3Pseq-KmgKD-1-CAGCGT_S1_R1_001_trimmed_clean_Aligned.sortedByCoord.out.Q255.chr.bed \
-g dm6.ucsc.chrom.sizes \
-scale 0.200285956 -bg -3 -strand + > 3Pseq-KmgKD-1-CAGCGT_S1_R1_001_trimmed_clean_Aligned.sortedByCoord.out.Q255.chr.bed_fw.bg

bedtools genomecov -i 3Pseq-KmgKD-2-GATCAC_S2_R1_001_trimmed_clean_Aligned.sortedByCoord.out.Q255.chr.bed \
-g dm6.ucsc.chrom.sizes \
-scale 0.185859746 -bg -3 -strand + > 3Pseq-KmgKD-2-GATCAC_S2_R1_001_trimmed_clean_Aligned.sortedByCoord.out.Q255.chr.bed_fw.bg
